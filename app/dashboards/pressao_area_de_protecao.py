# app/dashboards/pressao_area_de_protecao.py
"""
Dashboard Dash – Pressão Geral em Áreas de Proteção Ambiental

Como registrar no Flask:
    ...
    def create_app():
        ...
        register_pressao_area_de_protecao_dashboard(server)   # rota: /pressao_area_de_protecao/
        return server
"""
...
roi = load_geojson(
    "https://raw.githubusercontent.com/imazon-cgi/ap/main/dataset/geojson/PRESSAO_GERAL_Area_de_Protecao.geojson"
)
...
df = load_df(
    "https://github.com/imazon-cgi/ap/raw/refs/heads/main/dataset/csv/PRESSAO_GERAL_Area_de_Protecao.parquet"
)
...
# =============================================================================
def register_pressao_area_de_protecao_dashboard(flask_server):
    dash_app = dash.Dash(
        __name__,
        server=flask_server,
        url_base_pathname="/pressao_area_de_protecao/",
                ...
                dbc.Col(
                    dbc.Card(
                        dbc.CardBody(
                            [
                                html.H1(
                                    "Análise de Pressão de Desmatamento - Amazônia Legal",
    ...
    def update_graphs(
        ...
        bar_fig.update_layout(
            ...
            font=dict(size=10),
            title=dict(
                text="Top 10 Áreas de Proteção Ambiental por Pressão de Desmatamento",
                x=0.5,
                xanchor="center",
            ),
        )
        ...
        map_fig.update_layout(
            title=dict(
                text="Mapa de Pressão de Desmatamento (km²)",
                x=0.5,
                xanchor="center",
                font={"size": 14},
            ),
        ...
        pie_uso_fig = px.pie(
            ...
            names="UF",
            color="MODALIDADE",
            title="Pressão Desmatamento por Estado (categoria)",
        )
        ...
        pie_unid_fig = px.pie(
            ...
            names="NOME",
            color="UF",
            title="Pressão Desmatamento por APA",
        )
    ...
    def download_csv(n_clicks, decimal_sep, remove_accents):
        ...
        return dcc.send_data_frame(
            out_df.to_csv,
            "pressao_area_de_protecao.csv",
            index=False,
            sep=decimal_sep,
            encoding="utf-8-sig",
        )

    # --------- devolve a instância Dash, se precisar ----------
    return dash_app
